...
export default function EditGuideSection ( {route, navigation} ) {
    ...
    // Update Guide Section with the edited information
        ...
        <View style={styles.container}>
           ...
           <Text style={styles.text}>Description:</Text>
            ...
            <TouchableOpacity
                    ...
                    <Text style={styles.buttonTitle}>Edit Sub-Guide</Text>
            </TouchableOpacity>
