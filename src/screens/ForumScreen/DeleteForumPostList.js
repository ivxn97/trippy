...
// Display List for deleting forum posts
export default function DeleteForumPostList ({ navigation }) {
       ...
       const ItemView = ({item}) => {
        return (
            <TouchableOpacity
                ...
                onPress={ ()=> navigation.navigate('Delete Forum Post', {title : item.title, description: item.description, 
    ...
    return (
        <View>
        <Text style={styles.HeadingList}>Delete A</Text>
        <Text style={styles.HeadingList}>Forum Thread</Text>
