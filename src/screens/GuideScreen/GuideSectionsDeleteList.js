...
export default function GuideSectionsDeleteList ({ navigation }) {
       ...
       const ItemView = ({item}) => {
        return (
            <TouchableOpacity
                ...
                onPress={ ()=> navigation.navigate('Delete Guide Section', {name:item.name, description: item.description})}>
